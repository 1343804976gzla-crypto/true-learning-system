...
async def start_concurrent_quiz(
        ...
        if repaired:
            ...
            for concept_id in repaired_ids:
                ...
                log_audit_change(
                    ...
                    after=concept,
                    actor=audit_actor,
                    origin_event_type="quiz_v2.auto_repair_concept",
            ...
            if seeded:
                ...
                for concept_id in seeded_ids:
                    ...
                    log_audit_change(
                        ...
                        after=concept,
                        actor=audit_actor,
                        origin_event_type="quiz_v2.seed_concept",
                        origin_public_id=concept.concept_id,
                    )
                db.commit()
    ...
    for i, (quiz, concept) in enumerate(zip(quizzes, concepts)):
        ...
        log_audit_change(
            ...
            after=test_record,
            actor=audit_actor,
            origin_event_type="quiz_v2.generate_test_record",
    ...
    log_audit_change(
        ...
        after=session,
        actor=audit_actor,
        origin_event_type="quiz_v2.start_session",
...
async def submit_concurrent_quiz(
    ...
    log_audit_change(
        ...
        after=session,
        actor=audit_actor,
        origin_event_type="quiz_v2.submit",
        origin_public_id=str(session.id),
    )
